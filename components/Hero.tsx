      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Gestiona tu inventario, clientes y fiados en segundos. La solución moderna para tiendas de barrio.
            </motion.p>
              ...
              <div className="relative bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-2xl border border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      <p className="text-sm font-semibold text-gray-900 dark:text-white">Inventario al día</p>
                      <p className="text-xs text-gray-500 dark:text-gray-400">En tiempo real</p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div>
                      <p className="text-sm font-semibold text-gray-900 dark:text-white">Clientes registrados</p>
                      <p className="text-xs text-gray-500 dark:text-gray-400">+150 activos</p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div>
                      <p className="text-sm font-semibold text-gray-900 dark:text-white">Fiados controlados</p>
                      <p className="text-xs text-gray-500 dark:text-gray-400">Cuentas claras</p>
                    </div>
                  </motion.div>
                </div>
              </div>
